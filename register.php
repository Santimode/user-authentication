...
if ($_POST) {
    ...
    if ($user->password !== $confirm_password) {
        ...
        switch ($result) {
            case "success":
                $message = '<div class="alert alert-success">Registration successful! You can now <a href="login.php" class="alert-link">login</a>.</div>';
                break;
            case "user_exists":
...
<head>
    ...
    <title>Register - Modern System</title>
